...
<section class="hero-section set-bg" data-setbg="img/prjct-bg-futball.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="hs-item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hs-text">
                                    <h4></h4>
                                    <h2 style="text-shadow: 2px 2px 4px black;">"Football doesn't build character,<br>it reveals character"</h2>
                                    <a href="#turfView" class="primary-btn">Explore</a>
...
if (isset($_POST['selGame'])) {
    ...
    <div class="container" id="turfView">
        <?php
