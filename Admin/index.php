...
$sql = "select count(*) as usercount from tbl_customer C inner join tbl_login L on C.login_id=L.loginid WHERE L.status='confirm' ORDER BY C.cust_id;";
$res = $obj->query($sql);
...
<div class="main-panel" style="margin-top: -21px;">
    <div class="content-wrapper pb-0">
        <div class="page-header flex-wrap">
            <h3 class="mb-0"> Hi, welcome Admin! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block"></span>
            </h3>
            <!-- <div class="d-flex">
                            ...
                            <div class="card-body px-3 py-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="color-card">
                                        <p class="mb-0 color-card-head">Number of Users</p>
                                        <h2 class="text-white"> <?php echo $row['usercount']; ?>
                                        </h2>
                                    </div>
